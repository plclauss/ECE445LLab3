...
static int Button1_Press = 0;
static int Button2_Last = 0;
static int Button2_Press = 0;

int getButton1(){
	int retval = Button1_Press;
	Button1_Press = 0;
	return retval;
}

int getButton2(){
	int retval = Button2_Press;
	Button2_Press = 0;
	return retval;
}
...
void Timer5A_Handler(void){
  ...
  int Button1_now = Butt1Press();             // execute user task
	if(Button1_now && !Button1_Last) Button1_Press = 1;
	Button1_Last = Button1_now;
	
  int Button2_now = Butt2Press();
	if(Button2_now && !Button2_Last) Button2_Press = 1;
